...
func BenchmarkMap(b *testing.B) {
	b.ReportAllocs()
	b.Run("fnSwitch", func(b *testing.B) {
		b.ReportAllocs()
		for i := 0; i < b.N; i++ {
			fnSwitch("a")()
		}
	})
	b.Run("fnMap", func(b *testing.B) {
		b.ReportAllocs()
		for i := 0; i < b.N; i++ {
			fnMap("a")()
		}
	})
	b.Run("fnMapGlobal", func(b *testing.B) {
		b.ReportAllocs()
		for i := 0; i < b.N; i++ {
			fnMapGlobal("a")()
		}
	})
	b.Run("fnIntMap", func(b *testing.B) {
		b.ReportAllocs()
		for i := 0; i < b.N; i++ {
			fnIntMap(a)()
		}
	})
	b.Run("fnIntMapGlobal", func(b *testing.B) {
		b.ReportAllocs()
		for i := 0; i < b.N; i++ {
			fnIntMapGlobal(a)()
		}
...
func fn1() int { return 1 }
func fn2() int { return 2 }

func fnSwitch(v string) fn {
	switch v {
	case "a":
		return fn1
	case "b":
...
func fnMap(v string) fn {
	return doFnMap(v, map[string]fn{
		"a": fn1,
		"b": fn2,
	})
}

func doFnMap(v string, m map[string]fn) fn {
	if f, ok := m[v]; ok {
		return f
	}
	return nil
...
var mm = map[string]fn{
	"a": fn1,
	"b": fn2,
}

func fnMapGlobal(v string) fn {
	if f, ok := mm[v]; ok {
		return f
	}
	return nil
